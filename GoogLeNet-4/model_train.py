...
def train_val_data_process():
    ...
    normalize = transforms.Normalize(  #标准化
        [0.21958752,0.20337795,0.18975882], #数据集的均值
        [0.07842003,0.0685706,0.06125752])  #数据集的标准差
    # 定义数据集处理方法变量
...
def matplot_acc_loss(train_process):
    ...
    plt.legend()
    # 先保存再显示
    plt.savefig("output.png")  # 默认保存为PNG格式
    plt.show()
...
if __name__ == '__main__':
    ...
    # 利用现有的模型进行模型的训练
    train_process = train_model_process(GoogLeNet, train_data, val_data, num_epochs=40)
